...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        self.chitchatbot = ChatBot('mybot', trainer='chatterbot.trainers.ChatterBotCorpusTrainer')
        self.chitchatbot.train("chatterbot.corpus.english")
        self.chitchatbot.set_trainer(ListTrainer)
    ...
    def generate_answer(self, question):
        ...
        if intent == 'dialogue':
            ...
            response = self.chitchatbot.get_response(question)#### YOUR CODE HERE ####
            return response
